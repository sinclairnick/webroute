...
The `@webroute/client` package can be used _with or without_ using `@webroute/core`. It primarily provides a headless, extremely flexible client interface which provides end-to-end typesafety.

It can be used with the fetching library of your choice and will expedite client-side development as well as reducing errors and mistakes, by enforcing your API contract.
