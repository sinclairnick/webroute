...
**Portable**: The resulting webroute is a bog-standard request handler, build on WinterCG web-standards. This makes them the most portable and future-proofed way to define endpoints for your next app.
...
[View the docs for `route`](/docs/building-apps/routes)
