...
<Accordions>
<Accordion title="Using @webroute/core?">
If you're using `webroute`s on the backend, you can convert this into the appropriate shape via the `FromWebroute` helper.
